...
function ToDoItem({ data, onDelete, onEdit, groups }) {
  ...
  const handleChangeState = event => setFieldAdd({ ...fieldAdd, group_id: event.target.value });
  ...
  return (
    <div className="todo-item">
      ...
      <Modal show={show === 'change-group'} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={() => onEdit({ _id: data._id, ...fieldAdd }) && handleClose()}>
            Chuyển
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      <Modal show={show === 'delete'} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button variant="danger" onClick={() => onDelete(data._id) && handleClose()}>
            Xoá ngay!
          </Button>
        </Modal.Footer>
      </Modal>
